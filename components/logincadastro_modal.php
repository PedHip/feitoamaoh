...
<!-- Modal Login -->
<div class="modal fade" id="loginModalMobile" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
    <main>
        <section id="card">
            <div class="cadastre">
                <h1>Cadastre-se</h1>
                <p>Não tem uma conta? Faça um cadastro para que possa realizar os seus pedidos</p>
                <button type="submit" class="cadastreBttn" id="linkCadastroMobile">criar conta</button>
            </div>
            <form id="formLogin">
                <div class="data">
                    <div id="display">
...
<!-- Modal Cadastro -->
<div class="modal fade" id="cadastroModalMobile" tabindex="-1" aria-labelledby="cadastroModalLabel" aria-hidden="true">
    <main>
        <section id="card2">
            <div class="cadastre">
                <h1>Bem-vindo de volta!</h1>
                <p>Faça login no nosso site para voltar a fazer seus pedidos</p>
                <button class="cadastreBttn" id="linkLoginMobile">sign in</button>
            </div>
            <div class="data">
                <div class="login">
                    <h1>Cadastre-se</h1>
